...
export default function LanguageSelector() {
  ...
  return (
    <div className="fixed top-4 right-4 z-[80] md:right-6 md:top-6">
      <div className="flex bg-[var(--color-parchment-light)] border-[2px] border-[var(--color-ink-black)] font-display shadow-[4px_4px_0_0_var(--color-ink-black)] p-0.5 group hover:shadow-[6px_6px_0_0_var(--color-ink-black)] transition-all">
        {languages.map((l) => (
          <button
            key={l}
            onClick={() => setLang(l)}
