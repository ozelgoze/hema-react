...
export default function LanguageSelector() {
  ...
  return (
    <div className="flex w-full bg-[var(--color-parchment-light)] border-[2px] border-[var(--color-ink-black)] font-display shadow-[2px_2px_0_0_var(--color-ink-black)] p-0.5 group hover:shadow-[4px_4px_0_0_var(--color-ink-black)] transition-all">
      {languages.map((l) => (
        <button
          key={l}
          onClick={() => setLang(l)}
